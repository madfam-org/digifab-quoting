...
**Type**: service
**Status**: production
**Registry product**: Cotiza (`cotiza`, live, front door cotiza.studio).
...
# Logs
enclii logs digifab-quoting-api --env prod -f                    # live tail
enclii logs digifab-quoting-api --env prod --since 1h -n 200     # last hour
...
# Rollback
enclii rollback digifab-quoting-api --env prod                   # previous release
enclii rollback digifab-quoting-api v42 --env prod

# Releases + deployment history
enclii releases digifab-quoting-api -n 20
...
enclii domains list --service digifab-quoting-api
enclii domains add my.example.com --service digifab-quoting-api   # auto-provisions tunnel route + DNS
